...
import com.fh.init.annon.AuthPassport;
...
public class UserController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@AuthPassport(name="用户列表",desc="用户管理")
